...
from .exceptions import DossierGenerationError
...
class DossierGenerator:
    ...
    async def generate(
        ...
        Raises:
            DossierGenerationError: If document assembly fails.
        """
        try:
            ...
            raise DossierGenerationError(f"Document generation failed: {e}") from e
